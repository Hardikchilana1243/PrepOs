...
export default function OnboardingError({
  ...
  return (
    <div className="min-h-screen bg-[#070A10] flex flex-col items-center justify-center text-center p-6">
      ...
      <p className="text-xs text-slate-400 max-w-md mt-1.5 leading-relaxed">
        We encountered a problem setting up your candidate diagnostic profile. Please try reloading.
      </p>
